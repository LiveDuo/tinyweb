...
#[cfg(not(test))]
extern "C" {
    fn __invoke_and_return(c_ptr: *const u8, c_len: u32, p_ptr: *const u8, p_len: u32);
...
#[cfg(test)]
unsafe fn __invoke_and_return(_c_ptr: *const u8, _c_len: u32, _p_ptr: *const u8, _p_len: u32) { }
#[cfg(test)]
...
pub fn invoke_and_return(code: &str, params: &[InvokeParam]) {
