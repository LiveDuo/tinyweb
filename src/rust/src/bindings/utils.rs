...
pub fn random() -> f32 {
    ...
    crate::js::invoke_and_return(code, &[]) as f32
}
...
pub fn get_property_f64(element: &ExternRef, property: &str) -> f64 {
    let code = "function(element, property){ return element[property]; }";
    crate::js::invoke_and_return(code, &[InvokeParam::ExternRef(element), InvokeParam::String(property)]) as f64
}
...
pub fn get_property_bool(element: &ExternRef, property: &str) -> bool {
    ...
    let v = crate::js::invoke_and_return(code, &[InvokeParam::ExternRef(element), InvokeParam::String(property)]);
    v == 1
}
...
pub fn get_property_string(element: &ExternRef, property: &str) -> String {
    ...
    let text_allocation_id = crate::js::invoke_and_return(code, &[InvokeParam::ExternRef(element), InvokeParam::String(property)]);
